            ...
            <div class="col-lg-3 d-none d-lg-block">
                {{-- <div class="col-lg-4">
                    <a href="" class="text-decoration-none">
                        <span class="h3 mt-5 text-primary bg-dark px-2">MY Shop</span>
                    </a>
                </div> --}}
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            {{-- <a href="cart.html" class="nav-item nav-link active">My Cart</a>
                                        ...
                                        @if (Auth::user()->image == null)
                                            @if (Auth::user()->gender == 'male')
                                                <img src="{{ asset('image/default_user.png') }}"
                                                    class="img-thumbnail shadow-sm" style="max-height: 30px" />
                                            @else
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item my-3" href="{{ route('user#accountChangePage') }}">
                                            @if (Auth::user()->image == null)
                                                @if (Auth::user()->gender == 'male')
                                                    <img src="{{ asset('image/default_user.png') }}"
                                                        class="img-thumbnail shadow-sm me-1" style="max-height: 30px" />
                                                @else
                                                    <img src="{{ asset('image/female_default.jpg') }}"
                                                        class="img-thumbnail shadow-sm me-1" style="max-height: 30px" />
                                                @endif
